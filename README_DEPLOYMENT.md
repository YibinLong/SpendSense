# 🚀 SpendSense Deployment - Quick Start
...
- ✅ **`spendsense/app/main.py`** - Updated CORS to allow Vercel domains

### Documentation Files
- 📖 **`WHAT_YOU_NEED_TO_DO.md`** - **START HERE** - Simple task list
- 📖 **`DEPLOYMENT_CHECKLIST.md`** - Checkbox checklist format
...
**Render Free Tier:**
- ❌ Database resets after 15 minutes of inactivity
- ❌ "Cold starts" (first request takes 30-60 seconds after inactivity)
- ✅ Good for demos and testing
- 💰 Upgrade to $7/month for persistent storage
...
- `spendsense.db` - Already in `.gitignore` ✅
...
- **Render**: Update in dashboard → Manual redeploy required
- **Vercel**: Update in dashboard → Auto-redeploys
